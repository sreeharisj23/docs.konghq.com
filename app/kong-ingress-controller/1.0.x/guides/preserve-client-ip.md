...
- [`KONG_TRUSTED_IPS`](/../../configuration/#trusted_ips)
- [`KONG_PROXY_LISTEN`](/../../configuration/#proxy_listen)
- [`KONG_REAL_IP_HEADER`](/../../configuration/#real_ip_header)
...
- [`KONG_TRUSTED_IPS`](/../../configuration/#trusted_ips)
- [`KONG_REAL_IP_HEADER`](/../../configuration/#real_ip_header)
- Optional [`KONG_REAL_IP_RECURSIVE`](/../../configuration/#real_ip_recursive)
